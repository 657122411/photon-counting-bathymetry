...
public class DirectionalXYChart extends JFrame implements ClusteringXYChart {
    ...
    private static File getClusterPointFile(String[] args, String dir) {
        ...
        return new File(new File(dir), "DirectionalOutput.txt");
    }
    ...
    public static void main(String args[]) {
        ...
        final DirectionalXYChart chart =
                new DirectionalXYChart(chartTitle);
